...
sub name : Tests(4) {
    ...
    is $obj->name, 'foo', '... and name successfully returns the expected value';

    ok $obj->name('bar'), '... and set the value successfully';
    is $obj->name, 'bar', '... and name successfully returns the expected value';
}
...
sub price : Tests(4) {
    ...
    is $obj->price, '$10', '... and price successfully returns the expected value';

    ok $obj->price('$20'), '... and set the value successfully';
    is $obj->price, '$20', '... and price successfully returns the expected value';
}
...
sub manufacturer_id : Tests(4) {
    ...
    is $obj->manufacturer_id, 100, '... and manufacturer_id successfully returns the expected value';

    ok $obj->manufacturer_id(200), '... and set the value successfully';
    is $obj->manufacturer_id, 200, '... and manufacturer_id successfully returns the expected value';
}
