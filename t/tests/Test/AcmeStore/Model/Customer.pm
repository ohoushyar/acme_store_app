...
sub first_name : Tests(4) {
    ...
    is $obj->first_name, 'foo', '... and first_name successfully returns the expected value';

    ok $obj->first_name('bar'), '... and set the value successfully';
    is $obj->first_name, 'bar', '... and first_name successfully returns the expected value';
}
...
sub last_name : Tests(4) {
    ...
    is $obj->last_name, 'bar', '... and last_name successfully returns the expected value';

    ok $obj->last_name('buzz'), '... and set the value successfully';
    is $obj->last_name, 'buzz', '... and last_name successfully returns the expected value';
}
