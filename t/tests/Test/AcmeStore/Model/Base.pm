...
sub startup : Tests(startup => 2) {
    ...
    system('mkdir ./tmp') == 0 or die 'Unable to make dir ./tmp' unless (-d './tmp');
    ok system("sqlite3 $path_to_db < ./sql/ddl.sql") == 0, 'created db successfully';
}
